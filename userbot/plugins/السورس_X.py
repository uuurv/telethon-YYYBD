...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "أهـلا بـك فـي تــليثـون العـرب  👾"
...
𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"""
        ...
        await edit_or_reply(event,
            ...
            f"**{EMOJI_TELETHON} ❬ ٍَ النسخـة :  ِ6.0.3  ٍَ❭**\n"
...
async def source(e):
    await edit_or_reply(e, "https://dashboard.heroku.com/new?template=https://github.com/telethon-Arab/teletho-help")
