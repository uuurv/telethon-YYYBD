...
async def iq(mention):
    ...
    await edit_or_reply(mention, f"⌔︙ تم رفع  [{iqth}{iqth2}](tg://user?id={user.id}) كحبه صاكه 🤑👙.")
...
async def iq(mention):
    ...
    iqth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    iqth2 = user.last_name.replace("\u2060", "") if user.last_name else user.username
    await edit_or_reply(mention, f"⌔︙ تم رفع  [{iqth}{iqth2}](tg://user?id={user.id}) مطي سبورتي 🐴.")
...
async def iq(mention):
    ...
    iqth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    iqth2 = user.last_name.replace("\u2060", "") if user.last_name else user.username
    await edit_or_reply(mention, f"⌔︙ تم رفع  [{iqth}{iqth2}](tg://user?id={user.id}) زباله معفنه 🗑.")
...
async def iq(mention):
    ...
    iqth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    iqth2 = user.last_name.replace("\u2060", "") if user.last_name else user.username
    await edit_or_reply(mention, f"⌔︙ تم رفع  [{iqth}{iqth2}](tg://user?id={user.id}) منشئ الكروب 👷‍♂️.")
...
async def iq(mention):
    ...
    iqth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    iqth2 = user.last_name.replace("\u2060", "") if user.last_name else user.username
    await edit_or_reply(mention, f"⌔︙ تم رفع  [{iqth}{iqth2}](tg://user?id={user.id}) مدير الكروب 🤵‍♂️.")
...
async def iq(mention):
    ...
    iqth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    iqth2 = user.last_name.replace("\u2060", "") if user.last_name else user.username
    await edit_or_reply(mention, f"⌔︙ تم رفع  [{iqth}{iqth2}](tg://user?id={user.id}) مطور الكروب 🦾.")
...
async def iq(mention):
    ...
    iqth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    iqth2 = user.last_name.replace("\u2060", "") if user.last_name else user.username
    await edit_or_reply(mention, f"⌔︙ تم رفع  [{iqth}{iqth2}](tg://user?id={user.id}) كواد ينيج 🍌.")
...
async def iq(mention):
    ...
    iqth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    iqth2 = user.last_name.replace("\u2060", "") if user.last_name else user.username
    await edit_or_reply(mention, f"⌔︙ تم رفع  [{iqth}{iqth2}](tg://user?id={user.id}) مرتبط 👩‍❤️‍💋‍👨.")
...
async def iq(mention):
    ...
    iqth = user.first_name.replace("\u2060", "") if user.first_name else user.username
    iqth2 = user.last_name.replace("\u2060", "") if user.last_name else user.username
    await edit_or_reply(mention, f"⌔︙ تم رفع  [{iqth}{iqth2}](tg://user?id={user.id}) مثلي 👨‍❤️‍💋‍👨 🏳️‍🌈.")
